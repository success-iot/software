        ...
        happy.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
              //  con.execute("POST","1","Happy",dateFormat.format(currentTime));
                Outcome outcome = new Outcome(null,null,null,"4","1", "Mood Test", "Happy");
                try{
        ...
        normal.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
              //  con.execute("POST","1","Normal",dateFormat.format(currentTime));
                Outcome outcome = new Outcome(null,null,null,"4","1","Mood Test", "Normal");
                try{
                    response = con.execute(outcome.toJson().toString()).get();
                    showResponse();
                }catch (Exception e){
        ...
        sad.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
             //   con.execute("POST","1","Sad",dateFormat.format(currentTime));
                Outcome outcome = new Outcome(null,null,null,"4","1","Mood Test", "Sad");
                try{
                    response = con.execute(outcome.toJson().toString()).get();
                    showResponse();
                }catch (Exception e){
